...
<#macro page_body>
    ...
    <div class="row">
        <h2 class="text-center">Test videos</h2>
        <#--<#list files as file>-->
    ...
    <div class="row">
        ...
        <#list files as file>
            ...
            <div class="col-lg-4 col-md-12 mb-4">
                            ...
                            <div class="modal-body mb-0 p-0">
                                <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
                                    <video id="video-${index}" controls preload="metadata" >
                                        <source class="embed-responsive-item" src="/video/${file}" type="video/mp4">
                                        Your browser does not support the video tag.
                                    </video>
                                </div>
                            </div>
                ...
                <!--Modal: Name-->
                <a><img class="img-fluid z-depth-1" src="/img/${file}" id="img-video-${index}" alt="video" data-toggle="modal" data-target="#modal-${index}"></a>
                <#assign index++>
            </div>
        </#list>
        <#--<!-- Grid column &ndash;&gt;-->
